    ...
    public partial class ints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountCustomers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountCustomers_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountCustomerId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AccountCustomers_AccountCustomerId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 0, "", "ef865468-7674-4e04-9e18-356be0aa24d8", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@localhost.com", true, "", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEJ3GSK3NUMZI3LuFH21JfALt5cf/snn6ojkegO3jK70WYEMBGgyEd75f1+xGXy0PGw==", "", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "5d1c7a8a-fff0-41d5-85e5-02b0c23da100", false, null, null, "admin@localhost.com" },
                    { 2L, 0, "", "ecb23745-0150-43de-8037-e2780ed0e936", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "administrator@localhost.com", true, "", false, null, "ADMINISTRATOR@LOCALHOST.COM", "ADMINISTRATOR@LOCALHOST.COM", "AQAAAAIAAYagAAAAEA12bdLQIBVdAfvXiyp9LP++kkkfYs9ljmYjCvAWeDgpE3nqLw1C92dcqwSmRYGGXw==", "", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "5feb54be-762a-4475-8cdb-609323e5197f", false, null, null, "administrator@localhost.com" },
                    { 3L, 0, "", "66e84e08-834b-493a-ad5f-301452c55d07", 0L, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "customer@localhost.com", true, "", false, null, "CUSTOMER@LOCALHOST.COM", "CUSTOMER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEKLNgKxGNBUIGBqqhL8IqhRZi5SVqgjOlMRiNv2BujVTSk0forsvKlGXWA6tUhEqWQ==", "", null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "3d94fbdc-afab-41a7-9278-b00f341cdc43", false, null, null, "customer@localhost.com" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountCustomers_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountCustomerId",
                table: "Transactions",
